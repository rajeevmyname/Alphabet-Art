...
for (let i = 65; i <= 90; i++) {
  ...
  alphabetImg.setAttribute("id", "alphabetImg");
  ...
  itemContainer.setAttribute("id", "overlay");
  container.appendChild(itemContainer);

  let crossIcon = document.createElement("i");
  crossIcon.classList.add("fa-solid", "fa-xmark");
  itemContainer.appendChild(crossIcon);

  let emptyImgTag = document.createElement("img");
  itemContainer.appendChild(emptyImgTag);
  emptyImgTag.setAttribute("id", "emptyImg");
  ...
  imgContainer.addEventListener("click", () => {
    ...
    emptyImgTag.src = alphabetImg.src;
